...
ERR_ROOT_PRIVILEGES = "<strong>Current user doesn't have root privileges</strong>.<br><br> If you don't run FIT as root <strong style=\"color:red\">packet capture</strong> and <strong style=\"color:red\">traceroute</strong> will be disabled"
